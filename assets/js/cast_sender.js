...
*/
	...
	var l = function () {
		...
		p = null,
		q = function ( a ) {
			return ( a = a.querySelector && a.querySelector( "script[nonce]" ) ) && ( a = a.nonce || a.getAttribute( "nonce" ) ) && n.test( a ) ?
				a :
				"";
		},
		r = function ( a, b ) {
	...
	var B = function () {
		...
		E = function ( a, b, e ) {
			...
			a instanceof A && a.constructor === A ?
				( d = a.g ) :
				( ( d = typeof a ), w( "expected object of type TrustedResourceUrl, got '" + a + "' of type " + (
					"object" != d ?
						d :
						a ?
							(
								Array.isArray( a ) ?
									"array" :
									d ) :
							"null" ) ), ( d = "type_error:TrustedResourceUrl" ) );
			c.src = d;
